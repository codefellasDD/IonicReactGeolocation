    ...
    <IonPage>
      ...
      <IonContent>
        <IonCard>
          ...
          <IonCardContent>
            <p>
              isAvailable on {platform}:{" "}
              {JSON.stringify(availableFeatures.getCurrentPosition)}
            </p>
            {availableFeatures.getCurrentPosition && (
              <>
                ...
                <p>
                  <IonButton onClick={handleRefreshPosition}>
        ...
        <IonCard>
          ...
          <IonCardContent>
            <p>
              isAvailable on {platform}:{" "}
              {JSON.stringify(availableFeatures.watchPosition)}
            </p>
            {availableFeatures.watchPosition && (
              <>
                ...
                <p>
                  <IonButton onClick={() => startWatch()}>
                    Start watching location
                  </IonButton>
                </p>
                <p>
                  <IonButton onClick={() => clearWatch()}>
